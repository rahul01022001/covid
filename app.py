...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                html.Div([
                    html.H2('Recovered Cases', className='text-light'),
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Div([
                    dcc.Dropdown(id = 'plot_graph',options = options1,value = 'All'),
                    dcc.Graph(id = 'graph')
                ],className = 'card-body')
            ],className = 'card bg-success')
        ],className = 'col-md-6'),
...
@app.callback(Output('graph','figure'),[Input('plot_graph','value')])
